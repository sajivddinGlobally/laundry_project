              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: Image.asset(mylist[index]["imageUrl"].toString()),
                  );
                },
              ),
            ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: Stack(
                      children: [
                        Image.asset(popularList[index]["imageUrl"].toString()),
                        Positioned(
                          top: 10.h,
                          left: 16.w,
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Icon(
                                  Icons.star,
                                  color: Color.fromARGB(255, 252, 213, 63),
                                  size: 20.sp,
                                ),
                              ],
                            ),
                ...
                return Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset(cardList[index]["imageUrl"].toString()),
                          SizedBox(width: 23.w),
                          Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  height: 25.h,
                                  decoration: BoxDecoration(
                                    color: Color.fromARGB(255, 114, 200, 243),
