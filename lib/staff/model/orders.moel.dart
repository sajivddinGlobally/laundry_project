...
AdminOrdersModel adminOrdersModelFromJson(String str) => AdminOrdersModel.fromJson(json.decode(str));

String adminOrdersModelToJson(AdminOrdersModel data) => json.encode(data.toJson());
...
class AdminOrdersModel {
    ...
    factory AdminOrdersModel.fromJson(Map<String, dynamic> json) => AdminOrdersModel(
