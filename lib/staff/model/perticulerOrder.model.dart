...
PerticulerOrderModel perticulerOrderModelFromJson(String str) =>
    PerticulerOrderModel.fromJson(json.decode(str));

String perticulerOrderModelToJson(PerticulerOrderModel data) =>
    json.encode(data.toJson());

class PerticulerOrderModel {
  String message;
  Data data;

  PerticulerOrderModel({
    required this.message,
    required this.data,
  });

  factory PerticulerOrderModel.fromJson(Map<String, dynamic> json) =>
      PerticulerOrderModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        totalBookedAmount: (json["total_booked_amount"] ?? 0).toDouble(),
        iroing: json["iroing"],
...
class ProductProduct {
  ...
  factory ProductProduct.fromJson(Map<String, dynamic> json) => ProductProduct(
        title: json["title"],
        image: json["image"],
        priceJson: List<ChosedService>.from(
            json["price_json"].map((x) => ChosedService.fromJson(x))),
      );
